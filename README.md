...
\item \textbf{运行环境}：网络使用 Pytorch 实现。实验在配备 4 个 NVIDIA A100 GPU 80GB 的服务器上并行训练，在15个配备NVIDIA RTX 5000 32GB的服务器上进行推理。采用脚本执行全脑血管分割、分析全流程Pipeline，并进行监控和管理。
...
• **Image Segmentation Data Scale**: Single data image size is $11400 \times 8000 \times 13200$. Whole-brain complete fine vasculature X 24 datasets; includes healthy / injured data. Voxel resolution: 0.35 x 0.35 x 1 μm.
